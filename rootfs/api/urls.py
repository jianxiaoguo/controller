...
app_urlpatterns = [
    ...
    # describe pod
    re_path(
        r"^apps/(?P<id>{})/pods/(?P<name>{})/describe/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
    ...
    # describe ptypes
    re_path(
        r"^apps/(?P<id>{})/ptypes/(?P<name>{})/describe/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
    ...
    re_path(
        r"^apps/(?P<id>{})/volumes/(?P<name>{})/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
        views.AppVolumesViewSet.as_view(
            {'get': 'retrieve', 'patch': 'expand', 'delete': 'destroy'})),
    re_path(
        r"^apps/(?P<id>{})/volumes/(?P<name>{})/path/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
    ...
    re_path(
        r"^apps/(?P<id>{})/resources/(?P<name>{})/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
        views.AppSingleResourceViewSet.as_view(
            {'get': 'retrieve', 'delete': 'destroy', 'put': 'update'})),
    re_path(
        r"^apps/(?P<id>{})/resources/(?P<name>{})/binding/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
    ...
    re_path(
        r'^apps/(?P<id>{})/certs/(?P<name>{})/?$'.format(settings.APP_URL_REGEX, settings.NAME_REGEX),
    ...
    # routes
    re_path(
        r"^apps/(?P<id>{})/routes/(?P<name>{})?/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
        views.RouteViewSet.as_view(
            {'post': 'create', 'get': 'list', 'delete': 'delete'})),
    re_path(
        r"^apps/(?P<id>{})/routes/(?P<name>{})/attach/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
        views.RouteViewSet.as_view({'patch': 'attach'})),
    re_path(
        r"^apps/(?P<id>{})/routes/(?P<name>{})/detach/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
        views.RouteViewSet.as_view({'patch': 'detach'})),
    re_path(
        r"^apps/(?P<id>{})/routes/(?P<name>{})/rules/?$".format(settings.APP_URL_REGEX, settings.NAME_REGEX),
